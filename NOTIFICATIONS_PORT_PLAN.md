...
- `42c2f2708d`, `da03810af4`, `9d7e395cb6`, `8b7182d321` — **ещё не разобраны**, остаются в очереди на индивидуальный разбор (каждый трогает разные подсистемы: doc-url в нотификациях, календарь/export/github пуши, todo-контекст, перевод уведомлений).
