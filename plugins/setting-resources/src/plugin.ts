...
export default mergeIds(settingId, setting, {
  ...
  string: {
    ...
    SignOutAllOtherSessions: '' as IntlString,
    SignOutAllOtherSessionsDialogTitle: '' as IntlString,
    SignOutAllOtherSessionsDialogMessage: '' as IntlString,
    SignOutAllOtherSessionsDialogAction: '' as IntlString,
    ActiveSessionsLegend: '' as IntlString,
    RecentLoginActivityDescription: '' as IntlString,
    RecentLoginActivityFilterAll: '' as IntlString,
    RecentLoginActivityFilterSuccessful: '' as IntlString,
    RecentLoginActivityFilterFailed: '' as IntlString,
    RecentLoginActivityEmptyFiltered: '' as IntlString,
    ReportSuspiciousActivityAction: '' as IntlString,
    AnomalyNewCountry: '' as IntlString,
    AnomalyImpossibleTravel: '' as IntlString,
    AnomalyRepeatedFailures: '' as IntlString,
    RecentLoginActivityBadgeCurrentSession: '' as IntlString,
    RecentLoginActivityBadgeSameIp: '' as IntlString,
    RecentLoginActivityBadgeOtherDevice: '' as IntlString,
