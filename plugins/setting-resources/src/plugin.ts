...
export default mergeIds(settingId, setting, {
  ...
  string: {
    ...
    GuestPermissionsTabDocumentGuest: '' as IntlString,
    GuestDocumentRoleHint: '' as IntlString,
    GuestSecurityProfile: '' as IntlString,
    GuestSecurityProfileViewer: '' as IntlString,
    GuestSecurityProfileViewerDescription: '' as IntlString,
    GuestSecurityProfileParticipant: '' as IntlString,
    GuestSecurityProfileParticipantDescription: '' as IntlString,
    GuestSecurityProfileAdvanced: '' as IntlString,
    GuestSecurityProfileAdvancedDescription: '' as IntlString,
    GuestSecurityProfileCustom: '' as IntlString,
    GuestSecurityProfileSource: '' as IntlString,
    GuestEffectiveAccess: '' as IntlString,
    GuestEffectiveActions: '' as IntlString,
    GuestEffectiveScope: '' as IntlString,
    GuestEffectiveSource: '' as IntlString,
    GuestActionView: '' as IntlString,
    GuestClassPermissionSource: '' as IntlString,
    GuestModuleDisabled: '' as IntlString,
    GuestSpaceMembership: '' as IntlString,
    GuestOwnRecords: '' as IntlString,
    GuestLinkedRecords: '' as IntlString,
    GuestDenied: '' as IntlString,
    GuestAdvancedSettings: '' as IntlString,
    GuestActivityVisibility: '' as IntlString,
    GuestActivityOwn: '' as IntlString,
    GuestActivityCollaborator: '' as IntlString,
    GuestActivityAny: '' as IntlString,
    GuestSecuritySaveFailed: '' as IntlString,
